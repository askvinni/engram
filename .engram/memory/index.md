...
| @.engram/memory/patterns/testing-tiers-no-live-processes-in-automated-tests.md | Tests requiring live gh/git/claude are manual E2E only — never automate them | adding new tests to the engram project; deciding whether to mock or directly invoke an external process in a test |
